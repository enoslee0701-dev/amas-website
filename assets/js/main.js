...
const i18n = {
 zh: {
  ...
  "chat.kb.programs":"学位课程有神学副学士（AB.Th）、神学学士（B.Th）、教牧学研究硕士（G.Dip）、道学硕士（M.Div）与教牧学 / 宣教学博士（D.Min / D.Miss）；证书与装备课程有平信徒指导者课程、牧会训练课程、牧会者进修、讲道学校与宣教士训练。2026 届 B.Th 招生进行中，9 月开学。","chat.kb.programsBtn":"查看培养项目",
  ...
  "hero.ai.title":"定制化神学 · 4 分钟发现你的基督徒成长角色","hero.ai.sub":"10 道题 · 九维快照 · 十二大成长角色","hero.ai.go":"立即测评 →",
  ...
  "programs.title":"培养项目","programs.desc":"从证书课程到博士研究，完整的阶梯式培养路径；2026 届 B.Th 招生已开放，其余项目按批次开放。",
  "programs.degree.title":"学位课程","programs.degree.sub":"按学术阶梯逐级修读，学籍由 AMAS 总校审核建立","programs.equip.title":"证书与装备课程","programs.equip.sub":"面向在职牧者与平信徒的短期训练",
  "programs.items.abth.name":"神学副学士","programs.items.abth.desc":"3 年制 · 100 学分 · 进入 B.Th 的学位阶梯","programs.items.laycert.badge":"证书","programs.items.laycert.name":"平信徒指导者课程","programs.items.laycert.desc":"1 年制 · 36 学分 · 每 3 个月集中学习 10 天","programs.items.pdip.badge":"文凭","programs.items.pdip.name":"牧会训练课程","programs.items.pdip.desc":"60 学分 · 可在线学习，修毕获结业证","application.programs.abth":"神学副学士 AB.Th","application.programs.laycert":"平信徒指导者课程（证书）","application.programs.pdip":"牧会训练课程（文凭）",
  "programs.items.bth.name":"神学学士","programs.items.bth.desc":"2026 届招生 · 2026 年 9 月开学 · 120 学分 · 线上 + 线下灵活学习",
  "programs.items.gdip.name":"教牧学研究硕士","programs.items.gdip.desc":"3 年制 · 90 学分 · 补修 1 年可获 M.Div 学位",
  "programs.items.mdiv.name":"道学硕士","programs.items.mdiv.desc":"3 年制 · 90 学分 · 面向全职事奉的完整神学与教牧装备",
  "programs.items.dmin.name":"教牧学博士 / 宣教学博士","programs.items.dmin.desc":"D.Min / D.Miss · 3–5 年 · 48 学分（含论文）",
  ...
  "digital.ai.cta":"4 分钟快速测评 · 抢先体验","digital.ai.ctaNote":"完整的 AI 九维评估与成长画像将在 App 端建立。",
 ...
 en: {
  ...
  "hero.ai.title":"Personalized Theology · Discover your Christian growth archetype in 4 minutes","hero.ai.sub":"10 questions · 9-dimension snapshot · 12 growth archetypes","hero.ai.go":"Start now →",
  ...
  "programs.degree.title":"Degree Programs","programs.degree.sub":"Progressive academic ladder; student status reviewed by AMAS","programs.equip.title":"Certificate & Equipping Programs","programs.equip.sub":"Short-term training for serving pastors and lay leaders",
  "programs.items.abth.name":"Associate Bachelor of Theology","programs.items.abth.desc":"3 years · 100 credits · first step on the degree ladder","programs.items.laycert.badge":"CERT","programs.items.laycert.name":"Lay Leader Course","programs.items.laycert.desc":"1 year · 36 credits · a 10-day intensive every 3 months","programs.items.pdip.badge":"DIP","programs.items.pdip.name":"Pastoral Training Diploma","programs.items.pdip.desc":"60 credits · available online · certificate of completion","application.programs.abth":"Associate Bachelor of Theology AB.Th","application.programs.laycert":"Lay Leader Course (Certificate)","application.programs.pdip":"Pastoral Training Diploma",
  "programs.items.bth.name":"Bachelor of Theology","programs.items.bth.desc":"Class of 2026 · starts September 2026 · 120 credits · flexible online + in-person",
  "programs.items.gdip.name":"Master of Ministry Studies (G.Dip)","programs.items.gdip.desc":"3 years · 90 credits · one further year leads to the M.Div",
  "programs.items.mdiv.name":"Master of Divinity","programs.items.mdiv.desc":"3 years · 90 credits · full theological and pastoral equipping for vocational ministry",
  "programs.items.dmin.name":"Doctor of Ministry / Missiology","programs.items.dmin.desc":"D.Min / D.Miss · 3–5 years · 48 credits incl. dissertation",
  ...
  "digital.ai.cta":"Try the 4-Minute Assessment","digital.ai.ctaNote":"The full nine-dimension AI assessment and growth profile will be built in the App.",
 ...
 ko: {
  ...
  "chat.kb.programs":"학위 과정: 신학준학사(AB.Th)·신학사(B.Th)·목회연구석사(G.Dip)·목회학석사(M.Div)·목회학/선교학박사(D.Min/D.Miss). 자격·훈련 과정: 평신도 지도자 과정, 목회 훈련 디플로마, 목회자 연수, 설교학교, 선교사 훈련. 2026학년도 B.Th 신입생 모집 중, 9월 개강.","chat.kb.programsBtn":"과정 안내 보기",
  ...
  "hero.ai.title":"맞춤 신학 · 4분 만에 나의 성장 역할 발견","hero.ai.sub":"10문항 · 9차원 스냅샷 · 12가지 성장 역할","hero.ai.go":"바로 평가 →",
  ...
  "programs.degree.title":"학위 과정","programs.degree.sub":"학문적 단계를 따라 수학하며, 학적은 AMAS 본교 심사로 등록됩니다","programs.equip.title":"자격·훈련 과정","programs.equip.sub":"현직 목회자와 평신도를 위한 단기 훈련",
  "programs.items.abth.name":"신학준학사","programs.items.abth.desc":"3년제 · 100학점 · 학위 과정의 첫 단계","programs.items.laycert.badge":"수료","programs.items.laycert.name":"평신도 지도자 과정","programs.items.laycert.desc":"1년제 · 36학점 · 3개월마다 10일 집중 과정","programs.items.pdip.badge":"디플로마","programs.items.pdip.name":"목회 훈련 디플로마","programs.items.pdip.desc":"60학점 · 온라인 수강 가능 · 수료증 발급","application.programs.abth":"신학준학사 AB.Th","application.programs.laycert":"평신도 지도자 과정(수료)","application.programs.pdip":"목회 훈련 디플로마",
  "programs.items.bth.name":"신학사","programs.items.bth.desc":"2026학년도 모집 · 2026년 9월 개강 · 120학점 · 온라인 + 오프라인",
  "programs.items.gdip.name":"목회연구석사 (G.Dip)","programs.items.gdip.desc":"3년제 · 90학점 · 1년 추가 이수 시 M.Div 취득",
  "programs.items.mdiv.name":"목회학석사","programs.items.mdiv.desc":"3년제 · 90학점 · 전임 사역을 위한 신학·목회 훈련",
  "programs.items.dmin.name":"목회학박사 / 선교학박사","programs.items.dmin.desc":"D.Min / D.Miss · 3–5년 · 48학점(논문 포함)",
  ...
  "digital.ai.cta":"4분 빠른 평가 · 미리 체험","digital.ai.ctaNote":"완전한 AI 9차원 평가와 성장 프로필은 App에서 만들어집니다.",
 ...
 th: {
  ...
  "chat.kb.programs":"หลักสูตรปริญญา: AB.Th·B.Th·G.Dip·M.Div·D.Min/D.Miss หลักสูตรประกาศนียบัตรและการอบรม: ผู้นำฆราวาส, ประกาศนียบัตรศิษยาภิบาล, อบรมศิษยาภิบาล, โรงเรียนเทศนา, อบรมมิชชันนารี ขณะนี้เปิดรับ B.Th รุ่นปี 2026 เปิดเรียนกันยายน","chat.kb.programsBtn":"ดูหลักสูตร",
  ...
  "hero.ai.title":"ศาสนศาสตร์เฉพาะบุคคล · ค้นพบบทบาทการเติบโตใน 4 นาที","hero.ai.sub":"10 ข้อ · ภาพรวม 9 มิติ · 12 บทบาทการเติบโต","hero.ai.go":"เริ่มเลย →",
  ...
  "programs.degree.title":"หลักสูตรปริญญา","programs.degree.sub":"เรียนตามลำดับขั้นทางวิชาการ สถานภาพนักศึกษาขึ้นทะเบียนโดยวิทยาลัยหลัก AMAS","programs.equip.title":"ประกาศนียบัตรและการอบรม","programs.equip.sub":"การอบรมระยะสั้นสำหรับศิษยาภิบาลและฆราวาส",
  "programs.items.abth.name":"อนุปริญญาศาสนศาสตร์ (AB.Th)","programs.items.abth.desc":"3 ปี · 100 หน่วยกิต · ขั้นแรกของเส้นทางปริญญา","programs.items.laycert.badge":"ใบรับรอง","programs.items.laycert.name":"หลักสูตรผู้นำฆราวาส","programs.items.laycert.desc":"1 ปี · 36 หน่วยกิต · เรียนเข้ม 10 วันทุก 3 เดือน","programs.items.pdip.badge":"ประกาศนียบัตร","programs.items.pdip.name":"ประกาศนียบัตรการฝึกศิษยาภิบาล","programs.items.pdip.desc":"60 หน่วยกิต · เรียนออนไลน์ได้ · รับใบสำเร็จ","application.programs.abth":"AB.Th","application.programs.laycert":"หลักสูตรผู้นำฆราวาส","application.programs.pdip":"ประกาศนียบัตรศิษยาภิบาล",
  "programs.items.bth.name":"ศาสนศาสตรบัณฑิต","programs.items.bth.desc":"รุ่นปี 2026 · เปิดเรียนกันยายน 2026 · 120 หน่วยกิต · ออนไลน์ + ออนไซต์",
  "programs.items.gdip.name":"ปริญญาโทศึกษาพันธกิจ (G.Dip)","programs.items.gdip.desc":"3 ปี · 90 หน่วยกิต · เรียนเพิ่ม 1 ปีรับ M.Div",
  "programs.items.mdiv.name":"ศาสนศาสตรมหาบัณฑิต","programs.items.mdiv.desc":"3 ปี · 90 หน่วยกิต · การเตรียมศาสนศาสตร์และศิษยาภิบาลเต็มรูปแบบ",
  "programs.items.dmin.name":"ดุษฎีบัณฑิตศาสนศาสตร์ / มิชชันวิทยา","programs.items.dmin.desc":"D.Min / D.Miss · 3–5 ปี · 48 หน่วยกิต (รวมวิทยานิพนธ์)",
  ...
  "digital.ai.cta":"ลองแบบประเมิน 4 นาที","digital.ai.ctaNote":"การประเมิน AI 9 มิติฉบับเต็มและโปรไฟล์การเติบโตจะสร้างในแอป",
