...
const i18n = {
 zh: {
  ...
  "chat.kb.programs":"学位课程采用学分制、按科修读：神学学士（B.Th，120 学分）、教牧学研究硕士（G.Dip，90 学分）、道学硕士（M.Div，90 学分）与教牧学 / 宣教学博士（D.Min / D.Miss，48 学分）；证书与装备课程有平信徒指导者课程、牧会训练课程、牧会者进修、讲道学校与宣教士训练。2026 届 B.Th 招生进行中，9 月开学。","chat.kb.programsBtn":"查看培养项目",
  ...
  "programs.title":"培养项目","programs.desc":"学分制 · 按科修读、按科缴费：从证书课程到博士研究，修满学分即可毕业；2026 届 B.Th 招生已开放，其余项目按批次开放。",
  ...
  "programs.items.bth.name":"神学学士","programs.items.bth.desc":"2026 届招生 · 2026 年 9 月开学 · 120 学分 · 按科修读、线上 + 线下",
 ...
 en: {
  ...
  "chat.kb.programs":"Degree programs are credit-based and taken course by course: B.Th (120 credits), G.Dip / Master of Ministry Studies (90), M.Div (90) and D.Min / D.Miss (48); certificate and equipping tracks: Lay Leader Course, Pastoral Training Diploma, pastoral continuing education, School of Preaching and Missionary Training. The B.Th Class of 2026 intake is open; classes start in September 2026.","chat.kb.programsBtn":"View programs",
  ...
  "programs.title":"Programs","programs.desc":"Credit-based, course by course: from certificate to doctoral study, graduate on completing the required credits. The B.Th Class of 2026 intake is open; other programs open in batches.",
  ...
  "programs.items.bth.name":"Bachelor of Theology","programs.items.bth.desc":"Class of 2026 · starts September 2026 · 120 credits · course by course, online + in-person",
 ...
 ko: {
  ...
  "chat.kb.programs":"학위 과정은 학점제·과목별 수강: 신학사(B.Th, 120학점)·목회연구석사(G.Dip, 90)·목회학석사(M.Div, 90)·목회학/선교학박사(D.Min/D.Miss, 48). 자격·훈련 과정: 평신도 지도자 과정, 목회 훈련 디플로마, 목회자 연수, 설교학교, 선교사 훈련. 2026학년도 B.Th 모집 중, 9월 개강.","chat.kb.programsBtn":"과정 안내 보기",
  ...
  "programs.title":"교육 프로그램","programs.desc":"학점제 · 과목별 수강·납부: 자격 과정부터 박사 연구까지, 필요 학점을 채우면 졸업합니다. 2026학년도 B.Th 모집 중, 나머지 과정은 기수별 개설.",
  ...
  "programs.items.bth.name":"신학사","programs.items.bth.desc":"2026학년도 모집 · 2026년 9월 개강 · 120학점 · 과목별 수강, 온라인 + 오프라인",
 ...
 th: {
  ...
  "chat.kb.programs":"หลักสูตรปริญญาเป็นระบบหน่วยกิต เรียนรายวิชา: B.Th (120)·G.Dip (90)·M.Div (90)·D.Min/D.Miss (48) หลักสูตรประกาศนียบัตรและอบรม: ผู้นำฆราวาส, ประกาศนียบัตรศิษยาภิบาล, อบรมศิษยาภิบาล, โรงเรียนเทศนา, อบรมมิชชันนารี เปิดรับ B.Th รุ่นปี 2026 เปิดเรียนกันยายน","chat.kb.programsBtn":"ดูหลักสูตร",
  ...
  "programs.title":"หลักสูตร","programs.desc":"ระบบหน่วยกิต เรียนและชำระรายวิชา: จากประกาศนียบัตรถึงปริญญาเอก ครบหน่วยกิตก็จบการศึกษา เปิดรับ B.Th รุ่นปี 2026 หลักสูตรอื่นเปิดตามรอบ",
  ...
  "programs.items.bth.name":"ศาสนศาสตรบัณฑิต","programs.items.bth.desc":"รุ่นปี 2026 · เปิดเรียนกันยายน 2026 · 120 หน่วยกิต · เรียนรายวิชา ออนไลน์ + ออนไซต์",
