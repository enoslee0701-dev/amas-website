...
const i18n = {
 zh: {
  ...
  "stats.courses":"官方课程 · 7 大类","stats.flex.title":"灵活学习","stats.flex.body":"线上线下同步学习","stats.global.title":"全球视野","stats.global.body":"跨文化学习与宣教网络","stats.team.title":"牧者团队","stats.team.body":"资深牧者与教师同行","stats.year":"2026 届神学学士 B.Th 招生启动",
  ...
  "courseCards.0.title":"四福音概论","courseCards.0.body":"四福音的整体脉络、基督见证与比较阅读。","courseCards.1.title":"马太福音","courseCards.1.body":"研读天国的信息，认识君王基督与门徒之道。","courseCards.2.title":"马可福音","courseCards.2.body":"跟随仆人基督的脚踪，认识十架之路。","courseCards.3.title":"路加福音","courseCards.3.body":"认识寻找失丧者的救主，与福音的普世性。","courseCards.4.title":"约翰福音","courseCards.4.body":"认识耶稣的身份与工作，因信祂的名得生命。","courseCards.5.title":"使徒行传","courseCards.5.body":"跟随初代教会的脚踪，看福音从耶路撒冷直到地极。","courseCards.6.title":"罗马书","courseCards.6.body":"系统研读因信称义的福音大纲与新生命之道。","courseCards.7.title":"哥林多前书","courseCards.7.body":"围绕教会秩序、十字架神学与群体建造研读书信。","courseCards.8.title":"哥林多后书","courseCards.8.body":"在软弱中认识神的安慰、能力与事奉者的职分。","courseCards.9.title":"加拉太书","courseCards.9.body":"持守唯独恩典的福音，活出圣灵里的自由。","courseCards.10.title":"以弗所书","courseCards.10.body":"认识教会作为基督身体的奥秘与在基督里的新生活。","courseCards.11.title":"腓立比书","courseCards.11.body":"在患难中以基督为至宝，学习喜乐与谦卑。","courseCards.12.title":"歌罗西书","courseCards.12.body":"认识基督的至高与丰盛，胜过一切虚假哲学。","courseCards.13.title":"帖撒罗尼迦前后书","courseCards.13.body":"主再来、复活、盼望、警醒与忍耐。","courseCards.14.title":"提摩太前书","courseCards.14.body":"学习教会的治理、职分与纯正教义的持守。","courseCards.15.title":"提摩太后书","courseCards.15.body":"从保罗的遗言学习忠心到底、传承福音。","courseCards.16.title":"提多书","courseCards.16.body":"建立健全的教会与合乎纯正教义的生活。","courseCards.17.title":"腓利门书","courseCards.17.body":"在一封短信中看见福音如何更新人际关系。","courseCards.18.title":"希伯来书","courseCards.18.body":"仰望更美的大祭司基督，持定所承认的指望。","courseCards.19.title":"雅各书","courseCards.19.body":"信心必有行为：智慧、言语与日常敬虔的操练。","courseCards.20.title":"彼得前书","courseCards.20.body":"作寄居的圣洁子民，在苦难中盼望荣耀。","courseCards.21.title":"彼得后书","courseCards.21.body":"在真知识中长进，警醒防备假师傅。","courseCards.22.title":"约翰一书","courseCards.22.body":"在光明、真理与爱中确知自己有永生。","courseCards.23.title":"约翰二书","courseCards.23.body":"在真理中行事相爱，谨防迷惑人的教导。","courseCards.24.title":"约翰三书","courseCards.24.body":"学习接待、同工与效法良善的榜样。","courseCards.25.title":"犹大书","courseCards.25.body":"为一次交付圣徒的真道竭力争辩。","courseCards.26.title":"启示录","courseCards.26.body":"从启示文学认识终末盼望与教会的得胜。","courseCards.27.title":"创世记","courseCards.27.body":"从起初认识创造、堕落与救赎的开端。","courseCards.28.title":"士师记","courseCards.28.body":"在各人任意而行的时代，看见神信实的拯救。","courseCards.29.title":"圣经综合概观","courseCards.29.body":"纵览全本圣经的结构、脉络与救赎主线。","courseCards.30.title":"圣经地理","courseCards.30.body":"借地理场景读懂圣经叙事。","courseCards.31.title":"研经标记法","courseCards.31.body":"以标记与归纳的方法，建立稳固的个人研经习惯。","courseCards.32.title":"旧约救赎预表神学","courseCards.32.body":"在经文与救赎历史中严谨认识预表及其指向。","courseCards.33.title":"基督教宗派与神学思想","courseCards.33.body":"主要传统、共同根基、重要分歧与合一。","courseCards.34.title":"平信徒系统神学","courseCards.34.body":"面向平信徒的教义总览，建立信仰框架。","courseCards.35.title":"福音派神学核心要义","courseCards.35.body":"把握福音派信仰的核心教义与立场。","courseCards.36.title":"处境化神学","courseCards.36.body":"在亚洲处境中忠于圣经地思考、表达与实践信仰。","courseCards.37.title":"基督教教育","courseCards.37.body":"以圣经原则建构教会与家庭的信仰教育。","courseCards.38.title":"改革宗（加尔文主义）与福音派神学","courseCards.38.body":"认识改革宗传统与福音派神学的渊源与异同。","courseCards.39.title":"基督教伦理","courseCards.39.body":"以圣经原则回应当代伦理议题。","courseCards.40.title":"世界观","courseCards.40.body":"辨析各样世界观，建立圣经的眼光。","courseCards.41.title":"宗教比较","courseCards.41.body":"认识主要宗教，持定福音的独特。","courseCards.42.title":"伊斯兰教理解","courseCards.42.body":"认识伊斯兰信仰与向穆斯林传福音。","courseCards.43.title":"中国异端","courseCards.43.body":"辨识异端邪说，持守纯正信仰。","courseCards.44.title":"新信徒事工","courseCards.44.body":"以系统方式陪伴初信者扎根信仰、融入教会。","courseCards.45.title":"新信徒教材","courseCards.45.body":"编写与使用初信栽培教材的实务。","courseCards.46.title":"基督徒生活基础","courseCards.46.body":"在日常生活中操练信仰、敬虔与见证。","courseCards.47.title":"确信生活","courseCards.47.body":"建立救恩确据，活出稳固而有盼望的信仰根基。","courseCards.48.title":"门徒生活","courseCards.48.body":"以门徒的身份跟随基督，建立稳定的生命节奏。","courseCards.49.title":"祷告与灵修生活","courseCards.49.body":"建立满有能力的祷告与稳定的灵修节奏。","courseCards.50.title":"礼拜学","courseCards.50.body":"认识崇拜的圣经意义与礼拜程序的安排。","courseCards.51.title":"传道法","courseCards.51.body":"掌握传福音的信息、方法与陪谈跟进之道。","courseCards.52.title":"异象与使命","courseCards.52.body":"教会使命、属灵异象与事奉方向。","courseCards.53.title":"小组运营","courseCards.53.body":"建立、带领与倍增健康的小组群体。","courseCards.54.title":"属灵争战","courseCards.54.body":"认识属灵争战的圣经原则，穿戴神所赐的全副军装。","courseCards.55.title":"神话语的内在医治","courseCards.55.body":"经文、祷告、身份、关系修复与生命更新。","courseCards.56.title":"讲道学","courseCards.56.body":"从释经到信息构成，学习忠实清晰的讲道。","courseCards.57.title":"讲道实习","courseCards.57.body":"在实际讲台操练中打磨讲道能力。","courseCards.58.title":"敬拜学","courseCards.58.body":"学习带领会众敬拜赞美的原则与技巧。","courseCards.59.title":"协谈学（牧会相谈）","courseCards.59.body":"学习倾听、辅导与属灵陪伴的基本功。","courseCards.60.title":"教会运营","courseCards.60.body":"从治理、同工配搭到事工规划的教会运营实务。","courseCards.61.title":"主日学教育","courseCards.61.body":"儿童与青少年主日学的理念与实务。","courseCards.62.title":"以色列文化","courseCards.62.body":"认识圣经背景中的以色列历史与文化。","courseCards.63.title":"世界教会史","courseCards.63.body":"纵览两千年教会的历程与属灵传承。","courseCards.64.title":"中国教会史与信仰根基","courseCards.64.body":"中国教会历史、信仰传承与处境中的持守。","courseCards.65.title":"希腊语","courseCards.65.body":"学习新约希腊文基础，直读原文经文。","courseCards.66.title":"希伯来语","courseCards.66.body":"掌握旧约希伯来文的入门要素。","courseCards.67.title":"人工智能与教牧实践","courseCards.67.body":"善用 AI 工具辅助讲章预备、牧养与事工管理。",
  "courses.filters.nt":"新约书卷","courses.filters.ot":"旧约书卷","courses.filters.tools":"语言与工具",
  "courses.title":"课程设置","courses.desc":"按学院最终课程表开设 68 门课程，分为新约书卷、旧约书卷、圣经基础与研经、神学与思想、实践神学与牧养、历史与文化、语言与工具七大类；学分制、按科修读。","courses.filterGroup":"课程筛选","courses.levelGroup":"按学位层级筛选","courses.byLevel":"学位层级","courses.note.all":"神学学士 B.Th 共 27 门 · 70 学分，加 5 项实践训练 7 学分，毕业合计 77 学分。硕士与博士方案仍在制定中。","courses.note.bth":"神学学士 B.Th：27 门课 · 70 学分，加 5 项实践训练 7 学分，毕业合计 77 学分。","courses.note.mdiv":"道学硕士 M.Div 的课程方案与逐课学分仍在制定中，确定前不显示学分。","courses.note.dmin":"教牧学博士 D.Min 的课程方案与逐课学分仍在制定中，确定前不显示学分。","courses.note.none":"这些课程暂未归入任何学位方案。","courses.byCategory":"课程分类","courses.levels.all":"全部层级","courses.levels.bth":"神学学士 B.Th","courses.levels.mdiv":"道学硕士 M.Div","courses.levels.dmin":"教牧学博士 D.Min","courses.levels.none":"其他课程","courses.credits":"{n} 学分","courses.ctaNote":"课程的开课批次、修读年限与申请条件，请咨询招生同工。","courses.ctaAdmissions":"查看招生信息","courses.filters.all":"全部","courses.filters.bible":"圣经基础与研经","courses.filters.theology":"神学与思想","courses.filters.ministry":"实践神学与牧养","courses.searchLabel":"按课程名称或编号搜索","courses.searchPlaceholder":"搜索课程名称或编号…","courses.searchClear":"清空搜索","courses.noResult":"没有找到匹配「{q}」的课程。可以换个关键词，或清空搜索看全部。","courses.count":"已显示 {n} 门课程","courses.more":"展开全部课程（还有 {n} 门）","courses.less":"收起课程列表",
  ...
  "digital.ai.cta":"3 分钟快速探索 · 抢先体验","digital.ai.ctaNote":"完整信仰成长档案（12 项事奉倾向 · 四层分别测量）在「AMAS 神学院」App 端建立。",
  ...
  "application.fields.program":"申请修读项目","application.fields.eduLevel":"最高学历","application.fields.eduSchool":"毕业学校（选填）","application.edu.secondary":"高中及以下","application.edu.college":"大专","application.edu.bachelor":"本科","application.edu.master":"硕士及以上","application.fields.mode":"偏好的学习方式","application.fields.gifts":"恩赐（选填）","application.fields.motivation":"异象与蒙召 / 信仰见证","application.ph.motivation":"可以从这四点写起，写多写少都可以，真实即可，不需要华丽的文字：\n1. 你是怎么信主的？生命中有过什么转折？\n2. 目前在教会或工场有哪些服事？\n3. 为什么在这个阶段想接受神学装备？\n4. 盼望日后如何服事神与人？",
 ...
 en: {
  ...
  "stats.courses":"Official courses · 7 categories","stats.flex.title":"Flexible Learning","stats.flex.body":"Online + in-person","stats.global.title":"Global Vision","stats.global.body":"Cross-cultural mission network","stats.team.title":"Pastoral Faculty","stats.team.body":"Mentors and teachers","stats.year":"B.Th Class of 2026 intake",
  ...
  "courseCards.0.title":"Survey of the Four Gospels","courseCards.0.body":"","courseCards.1.title":"Matthew","courseCards.1.body":"The message of the Kingdom: Christ the King and the way of discipleship.","courseCards.2.title":"Mark","courseCards.2.body":"Follow the Servant-King to the cross in the fast-moving Gospel.","courseCards.3.title":"Luke","courseCards.3.body":"The Saviour who seeks the lost and the gospel for all nations.","courseCards.4.title":"John","courseCards.4.body":"Who Jesus is and what he did, that you may have life in his name.","courseCards.5.title":"Acts","courseCards.5.body":"The gospel from Jerusalem to the ends of the earth through the early church.","courseCards.6.title":"Romans","courseCards.6.body":"A systematic study of justification by faith and the new life.","courseCards.7.title":"1 Corinthians","courseCards.7.body":"Church order, the theology of the cross and building community.","courseCards.8.title":"2 Corinthians","courseCards.8.body":"God's comfort and power in weakness, and the ministry of reconciliation.","courseCards.9.title":"Galatians","courseCards.9.body":"Holding fast to the gospel of grace alone and freedom in the Spirit.","courseCards.10.title":"Ephesians","courseCards.10.body":"The mystery of the church as Christ's body and the new life in him.","courseCards.11.title":"Philippians","courseCards.11.body":"Joy and humility with Christ as our treasure, even in hardship.","courseCards.12.title":"Colossians","courseCards.12.body":"The supremacy and fullness of Christ over every empty philosophy.","courseCards.13.title":"1–2 Thessalonians","courseCards.13.body":"","courseCards.14.title":"1 Timothy","courseCards.14.body":"Church order, leadership and guarding sound doctrine.","courseCards.15.title":"2 Timothy","courseCards.15.body":"Paul's final charge: finish faithfully and pass on the gospel.","courseCards.16.title":"Titus","courseCards.16.body":"Establishing healthy churches and lives that fit sound doctrine.","courseCards.17.title":"Philemon","courseCards.17.body":"How the gospel transforms relationships, in one short letter.","courseCards.18.title":"Hebrews","courseCards.18.body":"Christ the greater High Priest; hold fast the hope we confess.","courseCards.19.title":"James","courseCards.19.body":"Faith that works: wisdom, speech and everyday godliness.","courseCards.20.title":"1 Peter","courseCards.20.body":"A holy people in exile, hoping for glory through suffering.","courseCards.21.title":"2 Peter","courseCards.21.body":"Growing in true knowledge and guarding against false teachers.","courseCards.22.title":"1 John","courseCards.22.body":"Assurance of eternal life: walking in light, truth and love.","courseCards.23.title":"2 John","courseCards.23.body":"Love in the truth and beware of deceivers.","courseCards.24.title":"3 John","courseCards.24.body":"Hospitality, partnership and imitating what is good.","courseCards.25.title":"Jude","courseCards.25.body":"Contend for the faith once for all delivered to the saints.","courseCards.26.title":"Revelation","courseCards.26.body":"Apocalyptic literature, final hope and the victory of the church.","courseCards.27.title":"Genesis","courseCards.27.body":"Creation, fall and the beginnings of redemption.","courseCards.28.title":"Judges","courseCards.28.body":"God's faithful deliverance in an age when everyone did as they pleased.","courseCards.29.title":"Bible Survey","courseCards.29.body":"The structure, storyline and redemptive thread of the whole Bible.","courseCards.30.title":"Bible Geography","courseCards.30.body":"Reading the biblical narrative through its lands and places.","courseCards.31.title":"Bible Marking Method","courseCards.31.body":"Marking and inductive techniques for solid personal study.","courseCards.32.title":"Old Testament Typology of Redemption","courseCards.32.body":"","courseCards.33.title":"Christian Traditions and Theological Thought","courseCards.33.body":"","courseCards.34.title":"Systematic Theology for Laypeople","courseCards.34.body":"A doctrine overview that builds a framework of faith.","courseCards.35.title":"Core Tenets of Evangelical Theology","courseCards.35.body":"The central doctrines and convictions of evangelical faith.","courseCards.36.title":"Contextual Theology","courseCards.36.body":"Faithful biblical thinking and practice in Asian contexts.","courseCards.37.title":"Christian Education","courseCards.37.body":"Biblical principles for faith formation in church and home.","courseCards.38.title":"Reformed (Calvinist) & Evangelical Theology","courseCards.38.body":"Origins, commonalities and differences of the Reformed and evangelical traditions.","courseCards.39.title":"Christian Ethics","courseCards.39.body":"Responding to contemporary ethical issues with biblical principles.","courseCards.40.title":"Worldview","courseCards.40.body":"Discerning worldviews and building a biblical perspective.","courseCards.41.title":"Comparative Religion","courseCards.41.body":"Understanding major religions and the uniqueness of the gospel.","courseCards.42.title":"Understanding Islam","courseCards.42.body":"Islamic belief and sharing the gospel with Muslims.","courseCards.43.title":"Cults in China","courseCards.43.body":"Recognising heresies and holding to sound faith.","courseCards.44.title":"New Believer Ministry","courseCards.44.body":"Systematically grounding new believers and integrating them into church.","courseCards.45.title":"New Believer Curriculum","courseCards.45.body":"Writing and using discipleship materials for new believers.","courseCards.46.title":"Foundations of Christian Living","courseCards.46.body":"Practising faith, godliness and witness in daily life.","courseCards.47.title":"Living in Assurance","courseCards.47.body":"Assurance of salvation and a stable, hope-filled faith.","courseCards.48.title":"The Disciple's Life","courseCards.48.body":"Following Christ as a disciple with a steady rhythm of life.","courseCards.49.title":"Prayer & Devotional Life","courseCards.49.body":"Powerful prayer and a steady devotional rhythm.","courseCards.50.title":"Liturgics","courseCards.50.body":"The biblical meaning of worship and ordering a service.","courseCards.51.title":"Evangelism Methods","courseCards.51.body":"The message, methods and follow-up of sharing the gospel.","courseCards.52.title":"Vision and Mission","courseCards.52.body":"","courseCards.53.title":"Small Group Ministry","courseCards.53.body":"Building, leading and multiplying healthy small groups.","courseCards.54.title":"Spiritual Warfare","courseCards.54.body":"Biblical principles of spiritual warfare and the armour of God.","courseCards.55.title":"Inner Healing through God's Word","courseCards.55.body":"","courseCards.56.title":"Homiletics","courseCards.56.body":"From exegesis to sermon form: faithful, clear preaching.","courseCards.57.title":"Preaching Practicum","courseCards.57.body":"Sharpening preaching through real pulpit practice.","courseCards.58.title":"Worship Leading","courseCards.58.body":"Principles and skills for leading congregational worship.","courseCards.59.title":"Pastoral Counselling","courseCards.59.body":"Listening, counselling and spiritual accompaniment.","courseCards.60.title":"Church Administration","courseCards.60.body":"Governance, team work and ministry planning in practice.","courseCards.61.title":"Sunday School Education","courseCards.61.body":"Philosophy and practice of Sunday school for children and youth.","courseCards.62.title":"Culture of Israel","courseCards.62.body":"The history and culture of Israel behind the biblical text.","courseCards.63.title":"World Church History","courseCards.63.body":"Two thousand years of the church and its spiritual heritage.","courseCards.64.title":"Chinese Church History and Faith Foundations","courseCards.64.body":"","courseCards.65.title":"Greek","courseCards.65.body":"New Testament Greek basics for reading the original text.","courseCards.66.title":"Hebrew","courseCards.66.body":"Essentials of Old Testament Hebrew.","courseCards.67.title":"AI & Pastoral Practice","courseCards.67.body":"Using AI tools wisely for sermon prep, care and ministry management.",
  "courses.filters.nt":"New Testament Books","courses.filters.ot":"Old Testament Books","courses.filters.tools":"Languages & Tools",
  "courses.title":"Curriculum","courses.desc":"68 courses from the seminary's official catalogue in seven categories: New Testament books, Old Testament books, Bible foundations & study, theology & thought, practical theology & pastoral care, history & culture, languages & tools — credit-based, course by course.","courses.filterGroup":"Filter courses","courses.levelGroup":"Filter by degree level","courses.byLevel":"Degree","courses.note.all":"The B.Th comprises 27 courses · 70 credits, plus 5 practical trainings worth 7 credits — 77 to graduate. The master’s and doctoral tracks are still being finalised.","courses.note.bth":"B.Th: 27 courses · 70 credits, plus 5 practical trainings worth 7 credits — 77 credits to graduate.","courses.note.mdiv":"The M.Div curriculum and its per-course credits are still being finalised; no credits are shown yet.","courses.note.dmin":"The D.Min curriculum and its per-course credits are still being finalised; no credits are shown yet.","courses.note.none":"These courses are not yet assigned to a degree track.","courses.byCategory":"Category","courses.levels.all":"All levels","courses.levels.bth":"B.Th","courses.levels.mdiv":"M.Div","courses.levels.dmin":"D.Min","courses.levels.none":"Other courses","courses.credits":"{n} credits","courses.ctaNote":"For intake dates, length of study and entry requirements, please ask the admissions team.","courses.ctaAdmissions":"See admissions","courses.filters.all":"All","courses.filters.bible":"Bible Foundations & Study","courses.filters.theology":"Theology & Thought","courses.filters.ministry":"Practical Theology & Pastoral Care","courses.searchLabel":"Search courses by name or code","courses.searchPlaceholder":"Search by course name or code…","courses.searchClear":"Clear search","courses.noResult":"No course matches “{q}”. Try another keyword, or clear the search to see all.","courses.count":"{n} courses shown","courses.more":"Show all courses ({n} more)","courses.less":"Show fewer courses",
  ...
  "digital.ai.cta":"Try the 3-Minute Quick Exploration","digital.ai.ctaNote":"The full faith-growth profile (12 ministry orientations, four layers measured separately) is built in the AMAS Seminary app.",
  ...
  "application.fields.program":"Program Applying For","application.fields.eduLevel":"Highest Education","application.fields.eduSchool":"School Graduated (optional)","application.edu.secondary":"High school or below","application.edu.college":"Associate / College","application.edu.bachelor":"Bachelor's degree","application.edu.master":"Master's or above","application.fields.mode":"Preferred Study Mode","application.fields.gifts":"Spiritual Gifts (optional)","application.fields.motivation":"Vision, Calling & Testimony","application.ph.motivation":"You can start from these four points. Length does not matter - honest words matter more than polished ones:\n1. How did you come to faith? Was there a turning point?\n2. What service are you involved in at your church or on the field now?\n3. Why do you want theological training at this stage?\n4. How do you hope to serve God and people afterwards?",
 ...
 ko: {
  ...
  "stats.courses":"공식 과목 · 7개 분야","stats.flex.title":"유연한 학습","stats.flex.body":"온·오프라인 병행 학습","stats.global.title":"글로벌 시야","stats.global.body":"타문화 학습과 선교 네트워크","stats.team.title":"목회자 교수진","stats.team.body":"경륜 있는 목회자·교사의 동행","stats.year":"2026학년도 신학사 B.Th 모집 시작",
  ...
  "courseCards.0.title":"사복음서 개론","courseCards.0.body":"","courseCards.1.title":"마태복음","courseCards.1.body":"천국의 메시지와 왕 되신 그리스도, 제자의 길을 연구합니다.","courseCards.2.title":"마가복음","courseCards.2.body":"종 되신 그리스도의 발자취와 십자가의 길을 따릅니다.","courseCards.3.title":"누가복음","courseCards.3.body":"잃은 자를 찾으시는 구주와 만민을 위한 복음을 배웁니다.","courseCards.4.title":"요한복음","courseCards.4.body":"예수의 정체와 사역을 알고 그 이름을 믿어 생명을 얻습니다.","courseCards.5.title":"사도행전","courseCards.5.body":"초대교회를 따라 예루살렘에서 땅끝까지 복음의 확장을 봅니다.","courseCards.6.title":"로마서","courseCards.6.body":"이신칭의의 복음 개요와 새 생명의 길을 체계적으로 연구합니다.","courseCards.7.title":"고린도전서","courseCards.7.body":"교회 질서, 십자가 신학, 공동체 세움을 연구합니다.","courseCards.8.title":"고린도후서","courseCards.8.body":"약함 속에서 하나님의 위로와 능력, 사역자의 직분을 배웁니다.","courseCards.9.title":"갈라디아서","courseCards.9.body":"오직 은혜의 복음을 지키며 성령 안의 자유를 삽니다.","courseCards.10.title":"에베소서","courseCards.10.body":"그리스도의 몸인 교회의 비밀과 그 안의 새 삶을 배웁니다.","courseCards.11.title":"빌립보서","courseCards.11.body":"환난 중에도 그리스도를 보배로 삼는 기쁨과 겸손을 배웁니다.","courseCards.12.title":"골로새서","courseCards.12.body":"모든 헛된 철학을 이기는 그리스도의 탁월함과 충만을 배웁니다.","courseCards.13.title":"데살로니가전후서","courseCards.13.body":"","courseCards.14.title":"디모데전서","courseCards.14.body":"교회의 치리와 직분, 바른 교리의 보전을 배웁니다.","courseCards.15.title":"디모데후서","courseCards.15.body":"바울의 유언에서 끝까지 충성하고 복음을 전수함을 배웁니다.","courseCards.16.title":"디도서","courseCards.16.body":"건강한 교회와 바른 교리에 합당한 삶을 세웁니다.","courseCards.17.title":"빌레몬서","courseCards.17.body":"짧은 편지 속에서 복음이 관계를 새롭게 함을 봅니다.","courseCards.18.title":"히브리서","courseCards.18.body":"더 나은 대제사장 그리스도를 바라보며 소망을 굳게 잡습니다.","courseCards.19.title":"야고보서","courseCards.19.body":"행함 있는 믿음: 지혜, 말, 일상의 경건을 훈련합니다.","courseCards.20.title":"베드로전서","courseCards.20.body":"나그네 된 거룩한 백성으로 고난 중에 영광을 소망합니다.","courseCards.21.title":"베드로후서","courseCards.21.body":"참 지식에서 자라며 거짓 교사를 경계합니다.","courseCards.22.title":"요한일서","courseCards.22.body":"빛과 진리와 사랑 안에서 영생의 확신을 얻습니다.","courseCards.23.title":"요한이서","courseCards.23.body":"진리 안에서 사랑하며 미혹하는 가르침을 경계합니다.","courseCards.24.title":"요한삼서","courseCards.24.body":"영접과 동역, 선한 본을 따름을 배웁니다.","courseCards.25.title":"유다서","courseCards.25.body":"단번에 성도에게 주신 믿음의 도를 위해 힘써 싸웁니다.","courseCards.26.title":"요한계시록","courseCards.26.body":"묵시문학을 통해 종말의 소망과 교회의 승리를 배웁니다.","courseCards.27.title":"창세기","courseCards.27.body":"창조와 타락, 구속의 시작을 배웁니다.","courseCards.28.title":"사사기","courseCards.28.body":"각자 소견대로 행하던 시대에 하나님의 신실한 구원을 봅니다.","courseCards.29.title":"성경 종합 개관","courseCards.29.body":"성경 전체의 구조와 흐름, 구속의 주선을 개관합니다.","courseCards.30.title":"성경 지리","courseCards.30.body":"지리적 배경을 통해 성경 이야기를 읽습니다.","courseCards.31.title":"성경 표기 연구법","courseCards.31.body":"표기와 귀납 방법으로 견고한 개인 성경 연구 습관을 세웁니다.","courseCards.32.title":"구약 구속 예표 신학","courseCards.32.body":"","courseCards.33.title":"기독교 교파와 신학 사상","courseCards.33.body":"","courseCards.34.title":"평신도 조직신학","courseCards.34.body":"평신도를 위한 교리 개관으로 신앙의 틀을 세웁니다.","courseCards.35.title":"복음주의 신학의 핵심","courseCards.35.body":"복음주의 신앙의 핵심 교리와 입장을 파악합니다.","courseCards.36.title":"상황화 신학","courseCards.36.body":"아시아 상황에서 성경에 충실하게 신앙을 사고하고 실천합니다.","courseCards.37.title":"기독교 교육","courseCards.37.body":"성경 원리로 교회와 가정의 신앙 교육을 세웁니다.","courseCards.38.title":"개혁주의(칼빈주의)와 복음주의 신학","courseCards.38.body":"개혁주의 전통과 복음주의 신학의 연원과 차이를 배웁니다.","courseCards.39.title":"기독교 윤리","courseCards.39.body":"성경 원리로 현대 윤리 문제에 응답합니다.","courseCards.40.title":"세계관","courseCards.40.body":"다양한 세계관을 분별하고 성경적 안목을 세웁니다.","courseCards.41.title":"종교 비교","courseCards.41.body":"주요 종교를 이해하고 복음의 독특성을 붙듭니다.","courseCards.42.title":"이슬람 이해","courseCards.42.body":"이슬람 신앙을 이해하고 무슬림에게 복음을 전합니다.","courseCards.43.title":"중국의 이단","courseCards.43.body":"이단을 분별하고 순수한 신앙을 지킵니다.","courseCards.44.title":"새신자 사역","courseCards.44.body":"체계적으로 새신자를 신앙에 뿌리내리고 교회에 정착시킵니다.","courseCards.45.title":"새신자 교재","courseCards.45.body":"새신자 양육 교재의 작성과 활용 실무입니다.","courseCards.46.title":"기독교인 생활 기초","courseCards.46.body":"일상에서 신앙과 경건, 증거를 훈련합니다.","courseCards.47.title":"확신의 생활","courseCards.47.body":"구원의 확신을 세우고 견고하고 소망 있는 신앙을 삽니다.","courseCards.48.title":"제자의 삶","courseCards.48.body":"제자로서 그리스도를 따르며 안정된 삶의 리듬을 세웁니다.","courseCards.49.title":"기도와 경건 생활","courseCards.49.body":"능력 있는 기도와 안정된 경건의 리듬을 세웁니다.","courseCards.50.title":"예배학","courseCards.50.body":"예배의 성경적 의미와 예배 순서 구성을 배웁니다.","courseCards.51.title":"전도법","courseCards.51.body":"복음의 메시지와 방법, 상담과 후속 양육을 익힙니다.","courseCards.52.title":"비전과 사명","courseCards.52.body":"","courseCards.53.title":"소그룹 운영","courseCards.53.body":"건강한 소그룹을 세우고 인도하며 배가합니다.","courseCards.54.title":"영적 전쟁","courseCards.54.body":"영적 전쟁의 성경 원리와 하나님의 전신갑주를 배웁니다.","courseCards.55.title":"말씀을 통한 내적 치유","courseCards.55.body":"","courseCards.56.title":"설교학","courseCards.56.body":"해석에서 메시지 구성까지 충실하고 명료한 설교를 배웁니다.","courseCards.57.title":"설교 실습","courseCards.57.body":"실제 강단 훈련으로 설교 역량을 다듬습니다.","courseCards.58.title":"예배 인도학","courseCards.58.body":"회중 찬양과 예배 인도의 원리와 기술을 배웁니다.","courseCards.59.title":"협담학(목회 상담)","courseCards.59.body":"경청과 상담, 영적 동행의 기본을 배웁니다.","courseCards.60.title":"교회 운영","courseCards.60.body":"치리와 동역, 사역 기획까지 교회 운영 실무입니다.","courseCards.61.title":"주일학교 교육","courseCards.61.body":"어린이와 청소년 주일학교의 이념과 실무입니다.","courseCards.62.title":"이스라엘 문화","courseCards.62.body":"성경 배경이 되는 이스라엘의 역사와 문화를 배웁니다.","courseCards.63.title":"세계 교회사","courseCards.63.body":"2천 년 교회의 여정과 영적 유산을 개관합니다.","courseCards.64.title":"중국 교회사와 신앙의 뿌리","courseCards.64.body":"","courseCards.65.title":"헬라어","courseCards.65.body":"신약 헬라어 기초를 배워 원문을 읽습니다.","courseCards.66.title":"히브리어","courseCards.66.body":"구약 히브리어 입문 요소를 익힙니다.","courseCards.67.title":"인공지능과 목회 실천","courseCards.67.body":"AI 도구를 설교 준비, 목양, 사역 관리에 지혜롭게 활용합니다.",
  "courses.filters.nt":"신약 각 권","courses.filters.ot":"구약 각 권","courses.filters.tools":"언어와 도구",
  "courses.title":"교육 과정","courses.desc":"학교 최종 과목표의 68개 과목을 신약 각 권, 구약 각 권, 성경 기초와 연구, 신학과 사상, 실천신학과 목양, 역사와 문화, 언어와 도구의 7개 분야로 개설합니다. 학점제·과목별 수강.","courses.filterGroup":"과목 필터","courses.levelGroup":"학위 과정별 필터","courses.byLevel":"학위 과정","courses.note.all":"신학사(B.Th)는 27개 과목 · 70학점에 실천 훈련 5항목 7학점을 더해 졸업 77학점입니다. 석사·박사 과정은 아직 확정 중입니다.","courses.note.bth":"신학사(B.Th): 27개 과목 · 70학점, 실천 훈련 5항목 7학점을 더해 졸업 77학점.","courses.note.mdiv":"목회학석사(M.Div) 과정과 과목별 학점은 아직 확정 중이어서 학점을 표시하지 않습니다.","courses.note.dmin":"목회학박사(D.Min) 과정과 과목별 학점은 아직 확정 중이어서 학점을 표시하지 않습니다.","courses.note.none":"이 과목들은 아직 학위 과정에 편성되지 않았습니다.","courses.byCategory":"분야","courses.levels.all":"전체 과정","courses.levels.bth":"신학사 B.Th","courses.levels.mdiv":"목회학석사 M.Div","courses.levels.dmin":"목회학박사 D.Min","courses.levels.none":"기타 과목","courses.credits":"{n}학점","courses.ctaNote":"개강 시기, 수업 기간, 지원 조건은 입학 담당자에게 문의해 주세요.","courses.ctaAdmissions":"입학 안내 보기","courses.filters.all":"전체","courses.filters.bible":"성경 기초와 연구","courses.filters.theology":"신학과 사상","courses.filters.ministry":"실천신학과 목양","courses.searchLabel":"과목명 또는 과목 코드로 검색","courses.searchPlaceholder":"과목명 또는 코드 검색…","courses.searchClear":"검색 지우기","courses.noResult":"「{q}」와 일치하는 과목이 없습니다. 다른 키워드를 써 보시거나 검색을 지우고 전체를 보세요.","courses.count":"{n}개 과목 표시 중","courses.more":"전체 과목 펼치기 (외 {n}과목)","courses.less":"과목 목록 접기",
  ...
  "digital.ai.cta":"3분 빠른 탐색 · 미리 체험","digital.ai.ctaNote":"전체 신앙 성장 프로필(12가지 사역 성향, 4개 영역 별도 측정)은 「AMAS 신학교」 앱에서 만들어집니다.",
  ...
  "application.fields.program":"지원 과정","application.fields.eduLevel":"최종 학력","application.fields.eduSchool":"출신 학교(선택)","application.edu.secondary":"고졸 이하","application.edu.college":"전문학사","application.edu.bachelor":"학사","application.edu.master":"석사 이상","application.fields.mode":"선호하는 학습 방식","application.fields.gifts":"은사(선택)","application.fields.motivation":"비전과 소명 / 신앙 간증","application.ph.motivation":"아래 네 가지에서 시작하시면 됩니다. 길이는 상관없으며, 화려한 표현보다 솔직한 내용이 더 중요합니다:\n1. 어떻게 주님을 믿게 되셨습니까? 삶에 전환점이 있었습니까?\n2. 현재 교회나 사역지에서 어떤 섬김을 하고 계십니까?\n3. 지금 이 시점에 신학 훈련을 받고자 하시는 이유는 무엇입니까?\n4. 앞으로 하나님과 사람을 어떻게 섬기기를 원하십니까?",
 ...
 th: {
  ...
  "courseCards.0.title":"ภาพรวมพระกิตติคุณทั้งสี่","courseCards.0.body":"","courseCards.1.title":"มัทธิว","courseCards.1.body":"ศึกษาข่าวสารแห่งอาณาจักร กษัตริย์พระคริสต์และวิถีสาวก","courseCards.2.title":"มาระโก","courseCards.2.body":"ติดตามพระคริสต์ผู้รับใช้สู่หนทางกางเขน","courseCards.3.title":"ลูกา","courseCards.3.body":"พระผู้ช่วยผู้แสวงหาคนหลง และข่าวประเสริฐเพื่อทุกชนชาติ","courseCards.4.title":"ยอห์น","courseCards.4.body":"รู้จักพระเยซูและพระราชกิจ เพื่อได้ชีวิตโดยเชื่อในพระนาม","courseCards.5.title":"กิจการ","courseCards.5.body":"ติดตามคริสตจักรยุคแรก ข่าวประเสริฐจากเยรูซาเล็มถึงสุดปลายแผ่นดินโลก","courseCards.6.title":"โรม","courseCards.6.body":"ศึกษาอย่างเป็นระบบเรื่องการชอบธรรมโดยความเชื่อและชีวิตใหม่","courseCards.7.title":"1 โครินธ์","courseCards.7.body":"ระเบียบคริสตจักร ศาสนศาสตร์กางเขน และการสร้างชุมชน","courseCards.8.title":"2 โครินธ์","courseCards.8.body":"การปลอบโยนและฤทธิ์ของพระเจ้าในความอ่อนแอ และพันธกิจผู้รับใช้","courseCards.9.title":"กาลาเทีย","courseCards.9.body":"ยึดมั่นข่าวประเสริฐแห่งพระคุณและเสรีภาพในพระวิญญาณ","courseCards.10.title":"เอเฟซัส","courseCards.10.body":"ความล้ำลึกของคริสตจักรในฐานะพระกายพระคริสต์และชีวิตใหม่","courseCards.11.title":"ฟีลิปปี","courseCards.11.body":"ความชื่นชมยินดีและความถ่อมใจ โดยมีพระคริสต์เป็นสมบัติล้ำค่า","courseCards.12.title":"โคโลสี","courseCards.12.body":"ความยิ่งใหญ่และความบริบูรณ์ของพระคริสต์เหนือปรัชญาอันว่างเปล่า","courseCards.13.title":"1–2 เธสะโลนิกา","courseCards.13.body":"","courseCards.14.title":"1 ทิโมธี","courseCards.14.body":"การปกครองคริสตจักร ตำแหน่งผู้นำ และการรักษาหลักคำสอนที่ถูกต้อง","courseCards.15.title":"2 ทิโมธี","courseCards.15.body":"คำสั่งเสียของเปาโล: สัตย์ซื่อจนถึงที่สุดและส่งต่อข่าวประเสริฐ","courseCards.16.title":"ทิตัส","courseCards.16.body":"สร้างคริสตจักรที่แข็งแรงและชีวิตที่สอดคล้องกับคำสอนที่ถูกต้อง","courseCards.17.title":"ฟีเลโมน","courseCards.17.body":"จดหมายสั้นที่แสดงว่าข่าวประเสริฐเปลี่ยนความสัมพันธ์อย่างไร","courseCards.18.title":"ฮีบรู","courseCards.18.body":"พระคริสต์มหาปุโรหิตผู้ประเสริฐกว่า ยึดความหวังที่เราสารภาพ","courseCards.19.title":"ยากอบ","courseCards.19.body":"ความเชื่อที่มีการกระทำ: ปัญญา คำพูด และความยำเกรงในชีวิตประจำวัน","courseCards.20.title":"1 เปโตร","courseCards.20.body":"ชนชาติบริสุทธิ์ผู้อาศัยชั่วคราว หวังในศักดิ์ศรีท่ามกลางความทุกข์","courseCards.21.title":"2 เปโตร","courseCards.21.body":"เติบโตในความรู้แท้และระวังผู้สอนเท็จ","courseCards.22.title":"1 ยอห์น","courseCards.22.body":"ความมั่นใจในชีวิตนิรันดร์ ดำเนินในความสว่าง ความจริง และความรัก","courseCards.23.title":"2 ยอห์น","courseCards.23.body":"รักในความจริงและระวังผู้ล่อลวง","courseCards.24.title":"3 ยอห์น","courseCards.24.body":"การต้อนรับ การร่วมงาน และการเลียนแบบสิ่งดี","courseCards.25.title":"ยูดา","courseCards.25.body":"ต่อสู้เพื่อความเชื่อที่ทรงมอบให้ธรรมิกชนครั้งเดียวเป็นพอ","courseCards.26.title":"วิวรณ์","courseCards.26.body":"วรรณกรรมวิวรณ์ ความหวังสุดท้าย และชัยชนะของคริสตจักร","courseCards.27.title":"ปฐมกาล","courseCards.27.body":"การทรงสร้าง การล้มลง และจุดเริ่มต้นแห่งการไถ่","courseCards.28.title":"ผู้วินิจฉัย","courseCards.28.body":"การช่วยกู้อันสัตย์ซื่อของพระเจ้าในยุคที่ต่างคนต่างทำตามใจ","courseCards.29.title":"ภาพรวมพระคัมภีร์","courseCards.29.body":"โครงสร้าง เส้นเรื่อง และแนวการไถ่ของพระคัมภีร์ทั้งเล่ม","courseCards.30.title":"ภูมิศาสตร์พระคัมภีร์","courseCards.30.body":"อ่านเรื่องราวพระคัมภีร์ผ่านภูมิประเทศและสถานที่","courseCards.31.title":"วิธีทำเครื่องหมายศึกษาพระคัมภีร์","courseCards.31.body":"เทคนิคทำเครื่องหมายและอุปนัยเพื่อการศึกษาส่วนตัวที่มั่นคง","courseCards.32.title":"ศาสนศาสตร์แบบเล็งถึงการไถ่ในพันธสัญญาเดิม","courseCards.32.body":"","courseCards.33.title":"นิกายคริสเตียนและแนวคิดทางศาสนศาสตร์","courseCards.33.body":"","courseCards.34.title":"ศาสนศาสตร์ระบบสำหรับฆราวาส","courseCards.34.body":"ภาพรวมหลักคำสอนเพื่อวางกรอบความเชื่อ","courseCards.35.title":"หลักสำคัญของศาสนศาสตร์อีแวนเจลิคัล","courseCards.35.body":"หลักคำสอนและจุดยืนสำคัญของความเชื่ออีแวนเจลิคัล","courseCards.36.title":"ศาสนศาสตร์เชิงบริบท","courseCards.36.body":"คิดและปฏิบัติความเชื่ออย่างซื่อตรงต่อพระคัมภีร์ในบริบทเอเชีย","courseCards.37.title":"คริสต์ศาสนศึกษา","courseCards.37.body":"หลักพระคัมภีร์สำหรับการศึกษาความเชื่อในคริสตจักรและครอบครัว","courseCards.38.title":"ศาสนศาสตร์ปฏิรูป (คาลวิน) และอีแวนเจลิคัล","courseCards.38.body":"ที่มา จุดร่วม และความต่างของสายปฏิรูปและอีแวนเจลิคัล","courseCards.39.title":"จริยศาสตร์คริสเตียน","courseCards.39.body":"ตอบประเด็นจริยธรรมร่วมสมัยด้วยหลักพระคัมภีร์","courseCards.40.title":"โลกทัศน์","courseCards.40.body":"แยกแยะโลกทัศน์ต่าง ๆ และสร้างมุมมองตามพระคัมภีร์","courseCards.41.title":"ศาสนาเปรียบเทียบ","courseCards.41.body":"เข้าใจศาสนาหลักและความเป็นเอกลักษณ์ของข่าวประเสริฐ","courseCards.42.title":"ความเข้าใจอิสลาม","courseCards.42.body":"ความเชื่ออิสลามและการประกาศข่าวประเสริฐแก่มุสลิม","courseCards.43.title":"ลัทธินอกรีตในจีน","courseCards.43.body":"แยกแยะคำสอนนอกรีตและรักษาความเชื่อที่บริสุทธิ์","courseCards.44.title":"พันธกิจผู้เชื่อใหม่","courseCards.44.body":"ช่วยผู้เชื่อใหม่หยั่งรากและเข้าร่วมคริสตจักรอย่างเป็นระบบ","courseCards.45.title":"หลักสูตรผู้เชื่อใหม่","courseCards.45.body":"การเขียนและใช้สื่อเลี้ยงดูผู้เชื่อใหม่","courseCards.46.title":"พื้นฐานชีวิตคริสเตียน","courseCards.46.body":"ฝึกความเชื่อ ความยำเกรง และการเป็นพยานในชีวิตประจำวัน","courseCards.47.title":"ชีวิตแห่งความมั่นใจ","courseCards.47.body":"ความมั่นใจในความรอดและความเชื่อที่มั่นคงมีความหวัง","courseCards.48.title":"ชีวิตสาวก","courseCards.48.body":"ติดตามพระคริสต์ในฐานะสาวกด้วยจังหวะชีวิตที่มั่นคง","courseCards.49.title":"การอธิษฐานและชีวิตเฝ้าเดี่ยว","courseCards.49.body":"การอธิษฐานที่มีฤทธิ์และจังหวะเฝ้าเดี่ยวที่มั่นคง","courseCards.50.title":"พิธีนมัสการ","courseCards.50.body":"ความหมายตามพระคัมภีร์ของการนมัสการและการจัดลำดับพิธี","courseCards.51.title":"วิธีประกาศข่าวประเสริฐ","courseCards.51.body":"ข่าวสาร วิธีการ และการติดตามผลในการประกาศ","courseCards.52.title":"นิมิตและพันธกิจ","courseCards.52.body":"","courseCards.53.title":"การดำเนินกลุ่มย่อย","courseCards.53.body":"สร้าง นำ และทวีคูณกลุ่มย่อยที่แข็งแรง","courseCards.54.title":"สงครามฝ่ายวิญญาณ","courseCards.54.body":"หลักพระคัมภีร์เรื่องสงครามฝ่ายวิญญาณและยุทธภัณฑ์ของพระเจ้า","courseCards.55.title":"การเยียวยาภายในด้วยพระวจนะ","courseCards.55.body":"","courseCards.56.title":"เทศนศาสตร์","courseCards.56.body":"จากการตีความสู่การเรียบเรียง เทศนาอย่างซื่อสัตย์และชัดเจน","courseCards.57.title":"ฝึกเทศนา","courseCards.57.body":"ฝึกฝนการเทศนาบนธรรมาสน์จริง","courseCards.58.title":"การนำนมัสการ","courseCards.58.body":"หลักและทักษะการนำนมัสการที่ประชุม","courseCards.59.title":"การให้คำปรึกษาอภิบาล","courseCards.59.body":"การฟัง การให้คำปรึกษา และการเดินเคียงข้างฝ่ายวิญญาณ","courseCards.60.title":"การบริหารคริสตจักร","courseCards.60.body":"การปกครอง การทำงานเป็นทีม และการวางแผนพันธกิจ","courseCards.61.title":"การศึกษารวีวารศึกษา","courseCards.61.body":"แนวคิดและการปฏิบัติรวีวารศึกษาสำหรับเด็กและเยาวชน","courseCards.62.title":"วัฒนธรรมอิสราเอล","courseCards.62.body":"ประวัติศาสตร์และวัฒนธรรมอิสราเอลเบื้องหลังพระคัมภีร์","courseCards.63.title":"ประวัติศาสตร์คริสตจักรโลก","courseCards.63.body":"สองพันปีของคริสตจักรและมรดกฝ่ายวิญญาณ","courseCards.64.title":"ประวัติศาสตร์คริสตจักรจีนและรากฐานความเชื่อ","courseCards.64.body":"","courseCards.65.title":"ภาษากรีก","courseCards.65.body":"พื้นฐานภาษากรีกพันธสัญญาใหม่เพื่ออ่านต้นฉบับ","courseCards.66.title":"ภาษาฮีบรู","courseCards.66.body":"พื้นฐานภาษาฮีบรูพันธสัญญาเดิม","courseCards.67.title":"ปัญญาประดิษฐ์กับการอภิบาล","courseCards.67.body":"ใช้เครื่องมือ AI อย่างชาญฉลาดในการเตรียมเทศนา การดูแล และการบริหารพันธกิจ",
  "courses.filters.nt":"พระธรรมพันธสัญญาใหม่","courses.filters.ot":"พระธรรมพันธสัญญาเดิม","courses.filters.tools":"ภาษาและเครื่องมือ",
  "courses.title":"รายวิชา","courses.desc":"68 วิชาจากตารางวิชาทางการ แบ่งเป็น 7 หมวด: พระธรรมพันธสัญญาใหม่ พันธสัญญาเดิม พื้นฐานและการศึกษาพระคัมภีร์ ศาสนศาสตร์และความคิด ศาสนศาสตร์ภาคปฏิบัติ ประวัติศาสตร์และวัฒนธรรม ภาษาและเครื่องมือ — ระบบหน่วยกิต เรียนรายวิชา","courses.filterGroup":"กรองรายวิชา","courses.levelGroup":"กรองตามระดับปริญญา","courses.byLevel":"ระดับปริญญา","courses.note.all":"หลักสูตร B.Th มี 27 วิชา · 70 หน่วยกิต รวมการฝึกภาคปฏิบัติ 5 รายการ 7 หน่วยกิต จบที่ 77 หน่วยกิต หลักสูตรปริญญาโทและเอกยังอยู่ระหว่างการจัดทำ","courses.note.bth":"B.Th: 27 วิชา · 70 หน่วยกิต รวมการฝึกภาคปฏิบัติ 5 รายการ 7 หน่วยกิต จบที่ 77 หน่วยกิต","courses.note.mdiv":"หลักสูตร M.Div และหน่วยกิตรายวิชายังอยู่ระหว่างการจัดทำ จึงยังไม่แสดงหน่วยกิต","courses.note.dmin":"หลักสูตร D.Min และหน่วยกิตรายวิชายังอยู่ระหว่างการจัดทำ จึงยังไม่แสดงหน่วยกิต","courses.note.none":"วิชาเหล่านี้ยังไม่ได้จัดเข้าหลักสูตรปริญญาใด","courses.byCategory":"หมวดวิชา","courses.levels.all":"ทุกระดับ","courses.levels.bth":"ปริญญาตรี B.Th","courses.levels.mdiv":"ปริญญาโท M.Div","courses.levels.dmin":"ปริญญาเอก D.Min","courses.levels.none":"วิชาอื่น ๆ","courses.credits":"{n} หน่วยกิต","courses.ctaNote":"รอบเปิดเรียน ระยะเวลาศึกษา และเงื่อนไขการสมัคร กรุณาสอบถามฝ่ายรับสมัคร","courses.ctaAdmissions":"ดูข้อมูลการรับสมัคร","courses.filters.all":"ทั้งหมด","courses.filters.bible":"พื้นฐานและการศึกษาพระคัมภีร์","courses.filters.theology":"ศาสนศาสตร์และความคิด","courses.filters.ministry":"ศาสนศาสตร์ภาคปฏิบัติและการอภิบาล","courses.searchLabel":"ค้นหาด้วยชื่อวิชาหรือรหัสวิชา","courses.searchPlaceholder":"ค้นหาชื่อวิชาหรือรหัส…","courses.searchClear":"ล้างการค้นหา","courses.noResult":"ไม่พบรายวิชาที่ตรงกับ “{q}” ลองใช้คำอื่น หรือล้างการค้นหาเพื่อดูทั้งหมด","courses.count":"แสดง {n} รายวิชา","courses.more":"ดูรายวิชาทั้งหมด (อีก {n} วิชา)","courses.less":"ย่อรายการวิชา",
  ...
  "digital.ai.cta":"สำรวจด่วน 3 นาที","digital.ai.ctaNote":"โปรไฟล์การเติบโตฉบับเต็ม (12 แนวโน้มการรับใช้ วัดแยก 4 ชั้น) สร้างในแอป AMAS",
  ...
  "application.fields.program":"หลักสูตรที่สมัคร","application.fields.eduLevel":"วุฒิการศึกษาสูงสุด","application.fields.eduSchool":"สถาบันที่จบ (ไม่บังคับ)","application.edu.secondary":"มัธยมปลายหรือต่ำกว่า","application.edu.college":"อนุปริญญา","application.edu.bachelor":"ปริญญาตรี","application.edu.master":"ปริญญาโทขึ้นไป","application.fields.mode":"รูปแบบเรียนที่ต้องการ","application.fields.gifts":"ของประทาน (ไม่บังคับ)","application.fields.motivation":"นิมิตกับการทรงเรียก / คำพยานความเชื่อ","application.ph.motivation":"เริ่มจากสี่ข้อนี้ได้เลย ความยาวไม่สำคัญ ขอเพียงเขียนตามความจริง ไม่ต้องใช้ถ้อยคำสวยงาม:\n1. คุณมาเชื่อพระเจ้าได้อย่างไร มีจุดเปลี่ยนในชีวิตไหม\n2. ปัจจุบันรับใช้อะไรในคริสตจักรหรือในสนามงาน\n3. ทำไมจึงต้องการรับการเตรียมด้านศาสนศาสตร์ในช่วงนี้\n4. หวังจะรับใช้พระเจ้าและผู้คนอย่างไรต่อไป",
...
function renderLevelNote(lv){
  const el = $(".level-note");
  if(!el) return;
  const key = "courses.note." + (["bth","mdiv","dmin","none"].includes(lv) ? lv : "all");
  el.dataset.i18n = key;
...
/* ===== 上传已填写的申请表：提交前守卫 + 提交后反馈 =====
   这张表单是原生 POST 到 formsubmit（action + target="_blank"），此前**一行 JS 都没有**，
   于是有四个问题，每一个都会让访客白填一次：

   一、accept=".doc,.docx,.pdf" 只是文件选择器的过滤条件，**不是校验**。
       访客在选择框里切到「所有文件」就能挑 .zip / .exe 传出去。
   二、没有任何体积上限。挑个几十 MB 的文件照样发出去，失败与否访客无从得知。
   三、target="_blank" 意味着原页面从头到尾不变。新标签页**一旦被拦截**
       （手机浏览器很常见），访客什么都看不到 —— 和资源中心那个静默失败一模一样。
   四、没有防重复提交。连点两次就给学校发两封邮件。

   **刻意不动投递路径**：站点别处用的是 formsubmit 的 ajax 端点，但那条路带附件能不能
   工作我无法验证（本轮禁止任何真实外发），贸然换掉可能弄坏一条本来能用的路。
   所以这里保持原生 POST 原样，只在它前后加守卫与反馈。 */

/* 客户端体积上限。这是**本站自己的守卫值**，不是对任何外部服务限制的断言；
   收件方是邮箱，附件太大本来就容易被退信。院方要调就改这一个常量。 */
const UPLOAD_MAX_BYTES = 10 * 1024 * 1024;
const UPLOAD_ALLOWED_EXT = ["doc", "docx", "pdf"];
...
/** 在上传表单里显示一条状态。kind 决定文案；ok=true 时是成功态。 */
function showUploadStatus(form, kind, vars, isOk){
  let box = form.querySelector(".upload-status");
  if(!box){
    box = document.createElement("p");
...
function clearUploadStatus(form){
  const box = form && form.querySelector(".upload-status");
  if(box) box.remove();
}
...
(function(){
  ...
  // 换了文件或改了任何输入，上一次的结论就不再成立，立刻撤掉
  form.addEventListener("input", () => clearUploadStatus(form));
  if(fileInput) fileInput.addEventListener("change", () => clearUploadStatus(form));

  form.addEventListener("submit", (e) => {
    // 防重复：在途期间的第二次提交直接吞掉，不再发一封
    if(sending){ e.preventDefault(); return; }

    const file = fileInput && fileInput.files && fileInput.files[0];
    if(!file){ return; }                       // 交给 required 的原生校验

    const ext = (file.name.split(".").pop() || "").toLowerCase();
    if(UPLOAD_ALLOWED_EXT.indexOf(ext) < 0){
      e.preventDefault();
      showUploadStatus(form, "upload.badType", { types: UPLOAD_ALLOWED_EXT.join(" / ") });
      return;                                   // 输入全部保留，访客换个文件即可
    }
    if(file.size > UPLOAD_MAX_BYTES){
      e.preventDefault();
      showUploadStatus(form, "upload.tooBig", {
        size: fmtSize(file.size), max: fmtSize(UPLOAD_MAX_BYTES) });
      return;
    }

    /* 先自己开一个具名窗口再把表单投进去 —— 这样才能知道新标签页是不是被拦了。
       直接写 target="_blank" 的话，被拦截时页面毫无反应，访客以为没提交成功。 */
    let win = null;
    try{ win = window.open("", "amasUploadTarget"); }catch(err){ win = null; }
    if(!win){
      e.preventDefault();
      showUploadStatus(form, "upload.popupBlocked");
      return;
    }
    form.target = "amasUploadTarget";
