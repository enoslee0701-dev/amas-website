...
const i18n = {
 zh: {
  ...
  "chat.kb.courses":"按学院最终课程表开设 67 门课程：新约书卷 27、旧约书卷 2、圣经基础与研经 3、神学与思想 11、实践神学与牧养 18、历史与文化 3、语言与工具 3；另有属灵训练项目。学分制、按科修读，硕士班 G.Dip / M.Div 毕业 90 学分。","chat.kb.coursesBtn":"浏览课程",
 ...
 en: {
  ...
  "chat.kb.courses":"The official catalogue offers 67 courses: 27 New Testament books, 2 Old Testament books, 3 Bible foundations & study, 11 theology & thought, 18 practical theology & pastoral care, 3 history & culture and 3 languages & tools, plus spiritual-training items. Credit-based, course by course; the G.Dip / M.Div track graduates with 90 credits.","chat.kb.coursesBtn":"Browse courses",
 ...
 ko: {
  ...
  "chat.kb.courses":"최종 과목표로 67개 과목을 개설합니다: 신약 각 권 27, 구약 각 권 2, 성경 기초와 연구 3, 신학과 사상 11, 실천신학과 목양 18, 역사와 문화 3, 언어와 도구 3, 그리고 영성 훈련 항목. 학점제·과목별 수강, 석사 과정(G.Dip / M.Div) 졸업 90학점.","chat.kb.coursesBtn":"과목 살펴보기",
  ...
  "courses.filters.history":"역사와 문화","training.0":"성경 통독 훈련(3회)","training.1":"성경 암송 훈련","training.2":"가정예배 훈련","training.3":"인간관계 훈련","training.4":"헌신 훈련","training.5":"설교 작성 100편(600쪽 이상)","training.6":"매일 1시간 기도(100일당 1학점)","training.7":"전도(5명당 1학점)","training.8":"Q.T 훈련(100일당 1학점)","training.9":"새벽기도(100일당 1학점)","training.10":"교회 개척","training.title":"영성 훈련과 졸업 요건","training.note":"석사 과정(G.Dip / M.Div)의 졸업 학점은 90점이며, 아래 훈련 항목은 학교의 확인으로 학점이 인정됩니다.","training.unit":"학점",
 ...
 th: {
  ...
  "chat.kb.courses":"ตารางวิชาทางการมี 67 วิชา: พันธสัญญาใหม่ 27, พันธสัญญาเดิม 2, พื้นฐานพระคัมภีร์ 3, ศาสนศาสตร์ 11, ศาสนศาสตร์ภาคปฏิบัติ 18, ประวัติศาสตร์ 3, ภาษาและเครื่องมือ 3 และรายการฝึกฝ่ายวิญญาณ ระบบหน่วยกิต หลักสูตร G.Dip / M.Div จบที่ 90 หน่วยกิต","chat.kb.coursesBtn":"ดูรายวิชา",
