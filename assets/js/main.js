...
const i18n = {
 zh: {
  ...
  "chat.kb.courses":"课程以圣经、神学、事工实践与生命塑造为主轴，现开设 25 门课程，含使徒行传、罗马书、系统神学、协谈学等。","chat.kb.coursesBtn":"浏览课程",
  "chat.kb.programs":"学位课程有神学学士（B.Th）、研究生文凭（G.Dip）、道学硕士（M.Div）与教牧学 / 宣教学博士（D.Min / D.Miss），另有牧会者进修、讲道学校、宣教士训练等装备课程；2026 届 B.Th 招生进行中，9 月 1 日开学。","chat.kb.programsBtn":"查看培养项目",
  ...
  "promo.tab":"2026 届招生进行中","promo.title":"2026 届神学学士 B.Th 招生中","promo.desc":"线上 + 清迈线下 · 按科修读 · 9 月 1 日开学。想先了解一下？招生助手随时为你解答。","promo.ask":"立即咨询","promo.apply":"申请入学","admissions.countdown":"距 2026 届开学还有 {n} 天","admissions.started":"2026 届已开学，欢迎咨询下一批次","actions.copy":"复制","toast.copied":"已复制","faq.ask.title":"还有其他问题？","faq.ask.desc":"AI 咨询助手可以随时解答；也可以直接留言给招生同工，我们会尽快回复你。","faq.ask.ai":"问 AI 咨询助手","faq.ask.leave":"给招生同工留言",
 ...
 en: {
  ...
  "chat.kb.courses":"The curriculum centers on Bible, theology, ministry practice and spiritual formation — 25 courses are offered, including Acts, Romans, Systematic Theology and Counseling.","chat.kb.coursesBtn":"Browse courses",
  "chat.kb.programs":"Degree programs: B.Th, G.Dip, M.Div and D.Min / D.Miss, plus training tracks for pastors, preaching and missionaries; the B.Th Class of 2026 intake is now open, classes start September 1.","chat.kb.programsBtn":"View programs",
  ...
  "promo.tab":"Admissions 2026 Open","promo.title":"B.Th Class of 2026 — Now Enrolling","promo.desc":"Online + on-site in Chiang Mai · pay per course · starts Sept 1. Curious? Our admissions assistant is here to help.","promo.ask":"Ask Now","promo.apply":"Apply","admissions.countdown":"{n} days until classes begin (Sept 1, 2026)","admissions.started":"Classes have begun — ask about the next intake","actions.copy":"Copy","toast.copied":"Copied","faq.ask.title":"Still have questions?","faq.ask.desc":"Our AI assistant is available anytime — or leave a message for the admissions team and we will reply soon.","faq.ask.ai":"Ask the AI assistant","faq.ask.leave":"Leave a message",
 ...
 ko: {
  ...
  "promo.tab":"2026학년도 모집 중","promo.title":"2026학년도 신학사 B.Th 모집 중","promo.desc":"온라인 + 치앙마이 오프라인 · 과목별 수강 · 9월 1일 개강. 먼저 알아보고 싶으신가요? 입학 도우미가 언제든 답해 드립니다.","promo.ask":"바로 상담","promo.apply":"입학 지원","admissions.countdown":"2026학년도 개강까지 {n}일","admissions.started":"개강했습니다 — 다음 기수를 문의해 주세요","actions.copy":"복사","toast.copied":"복사되었습니다","faq.ask.title":"더 궁금한 점이 있으신가요?","faq.ask.desc":"AI 상담 도우미가 언제든 답해 드립니다. 입학 담당자에게 직접 메시지를 남기셔도 빠르게 회신드립니다.","faq.ask.ai":"AI 상담 도우미에게 묻기","faq.ask.leave":"입학처에 메시지 남기기",
 ...
 th: {
  ...
  "promo.tab":"เปิดรับสมัครรุ่น 2026","promo.title":"เปิดรับสมัคร B.Th รุ่นปี 2026","promo.desc":"ออนไลน์ + ออนไซต์เชียงใหม่ · เรียนรายวิชา · เปิดเรียน 1 ก.ย. อยากทราบเพิ่มเติม? ผู้ช่วยรับสมัครพร้อมตอบทุกเมื่อ","promo.ask":"สอบถามเลย","promo.apply":"สมัครเรียน","admissions.countdown":"อีก {n} วันจะเปิดเรียนรุ่นปี 2026","admissions.started":"เปิดเรียนแล้ว — สอบถามรุ่นถัดไปได้","actions.copy":"คัดลอก","toast.copied":"คัดลอกแล้ว","faq.ask.title":"ยังมีคำถามอื่นอีกไหม?","faq.ask.desc":"ผู้ช่วย AI ตอบได้ตลอดเวลา หรือฝากข้อความถึงฝ่ายรับสมัครโดยตรง เราจะติดต่อกลับโดยเร็ว","faq.ask.ai":"ถามผู้ช่วย AI","faq.ask.leave":"ฝากข้อความถึงฝ่ายรับสมัคร",
...
function refreshCountdown(){
  ...
  el.textContent = days > 0 ? t("admissions.countdown", { n: days }) : t("admissions.started");
}
refreshCountdown();
