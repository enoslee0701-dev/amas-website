...
const i18n = {
 zh: {
  ...
  "chat.kb.programs":"学位课程有神学学士（B.Th）、研究生文凭（G.Dip）、道学硕士（M.Div）与教牧学 / 宣教学博士（D.Min / D.Miss），另有牧会者进修、讲道学校、宣教士训练等装备课程；2026 届 B.Th 招生进行中，9 月开学。","chat.kb.programsBtn":"查看培养项目",
  ...
  "hero.ai.title":"定制化神学 · 3 分钟发现你的属灵成长阶段","hero.ai.sub":"8 道题 · 四维快照 · 专属成长建议","hero.ai.go":"立即测评 →",
  ...
  "giving.title":"奉献支持","giving.verse":"“各人要随本心所酌定的，不要作难，不要勉强，因为捐得乐意的人是神所喜爱的。”","giving.verseRef":"—— 哥林多后书 9:7","giving.desc":"神学教育是一场同工的事奉。你的奉献将帮助愿意受装备的学员走完学习的路，也支持教学与宣教事工继续前行。","giving.d1":"学员助学","giving.d1b":"资助经济困难的学员完成装备","giving.d2":"教学事工","giving.d2b":"支持教师团队与课程建设","giving.d3":"宣教士训练","giving.d3b":"支持差派预备中的工人","giving.how":"奉献方式","giving.tab.wechat":"微信","giving.tab.alipay":"支付宝","giving.tab.thai":"泰国转账","giving.tab.intl":"海外","giving.qrSoon":"收款码即将开通，可先联系招生同工奉献。","giving.thaiSoon":"泰国银行账户信息即将公布，可先联系我们获取。","giving.intlSoon":"PayPal 与国际电汇信息即将公布，可先邮件联系 amasthai2026@gmail.com。","giving.notify":"奉献后请告诉我们","giving.notifyDesc":"留下你的信息，方便同工确认并为你献上感恩；如需奉献确认或了解使用情况，也欢迎注明。","giving.fName":"姓名","giving.fAmount":"金额（选填）","giving.fDir":"奉献方向","giving.dGeneral":"由学校统筹安排","giving.fContact":"联系方式（选填）","giving.send":"发送通知","giving.ok":"已收到，愿主纪念你的摆上！","giving.fail":"发送失败，请稍后再试，或直接联系我们。","giving.note":"奉献完全出于自愿，用于学员助学、教学与宣教事工；如需了解奉献的使用情况，欢迎随时与我们联系。","faq.items.4.q":"我可以怎样支持 AMAS？","faq.items.4.a":"欢迎以代祷参与，也可以为学员助学、教学与宣教事工奉献，详见「奉献支持」版块；把学院介绍给身边合适的人同样是宝贵的支持。",
 ...
 en: {
  ...
  "chat.kb.programs":"Degree programs: B.Th, G.Dip, M.Div and D.Min / D.Miss, plus training tracks for pastors, preaching and missionaries; the B.Th Class of 2026 intake is now open, classes start in September 2026.","chat.kb.programsBtn":"View programs",
  ...
  "hero.ai.title":"Personalized Theology · Discover your growth stage in 3 minutes","hero.ai.sub":"8 questions · 4-dimension snapshot · personal next steps","hero.ai.go":"Start now →",
  ...
  "giving.title":"Giving & Support","giving.verse":"“Each of you should give what you have decided in your heart to give, not reluctantly or under compulsion, for God loves a cheerful giver.”","giving.verseRef":"— 2 Corinthians 9:7","giving.desc":"Theological education is a shared ministry. Your giving helps committed students finish their training, and keeps the teaching and mission work moving forward.","giving.d1":"Student Aid","giving.d1b":"Help students in financial hardship complete their training","giving.d2":"Teaching Ministry","giving.d2b":"Support the faculty and curriculum development","giving.d3":"Missionary Training","giving.d3b":"Support workers preparing to be sent","giving.how":"Ways to Give","giving.tab.wechat":"WeChat","giving.tab.alipay":"Alipay","giving.tab.thai":"Thai Bank","giving.tab.intl":"International","giving.qrSoon":"Payment QR coming soon — please contact our team to give for now.","giving.thaiSoon":"Thai bank details will be published soon; contact us to receive them.","giving.intlSoon":"PayPal and wire details coming soon; please email amasthai2026@gmail.com.","giving.notify":"Let Us Know After Giving","giving.notifyDesc":"Leave your details so our team can confirm and give thanks for you; note if you need a confirmation or a report of use.","giving.fName":"Name","giving.fAmount":"Amount (optional)","giving.fDir":"Designation","giving.dGeneral":"Where most needed","giving.fContact":"Contact (optional)","giving.send":"Send Notice","giving.ok":"Received — may the Lord remember your gift!","giving.fail":"Failed to send. Please try again or contact us directly.","giving.note":"Giving is entirely voluntary and is used for student aid, teaching and mission; you are welcome to ask how gifts are used at any time.","faq.items.4.q":"How can I support AMAS?","faq.items.4.a":"Pray for us, give toward student aid, teaching or missionary training (see the Giving section), or simply introduce AMAS to someone who should know about it.",
 ...
 ko: {
  ...
  "giving.title":"후원과 동역","giving.verse":"“각각 그 마음에 정한 대로 할 것이요 인색함으로나 억지로 하지 말지니 하나님은 즐겁게 내는 자를 사랑하시느니라.”","giving.verseRef":"— 고린도후서 9:7","giving.desc":"신학 교육은 함께 세워가는 사역입니다. 당신의 후원은 훈련받기 원하는 학생이 학업을 마치도록 돕고, 교육과 선교 사역을 지탱합니다.","giving.d1":"학생 장학","giving.d1b":"경제적 어려움이 있는 학생의 훈련을 돕습니다","giving.d2":"교육 사역","giving.d2b":"교수진과 커리큘럼을 지원합니다","giving.d3":"선교사 훈련","giving.d3b":"파송을 준비하는 일꾼을 돕습니다","giving.how":"후원 방법","giving.tab.wechat":"위챗","giving.tab.alipay":"알리페이","giving.tab.thai":"태국 송금","giving.tab.intl":"해외","giving.qrSoon":"QR 코드는 공개 예정입니다. 먼저 담당자에게 문의해 주세요.","giving.thaiSoon":"태국 은행 계좌는 공개 예정입니다. 연락하시면 안내해 드립니다.","giving.intlSoon":"PayPal과 송금 정보는 공개 예정입니다. amasthai2026@gmail.com 으로 먼저 연락해 주세요.","giving.notify":"후원 후 알려주세요","giving.notifyDesc":"정보를 남겨 주시면 확인 후 감사를 드립니다. 확인서나 사용 내역이 필요하면 기재해 주세요.","giving.fName":"이름","giving.fAmount":"금액(선택)","giving.fDir":"후원 방향","giving.dGeneral":"학교 재량에 맡김","giving.fContact":"연락처(선택)","giving.send":"알림 보내기","giving.ok":"접수되었습니다. 주님께서 당신의 드림을 기억하시기를!","giving.fail":"전송 실패. 잠시 후 다시 시도하거나 직접 연락해 주세요.","giving.note":"후원은 전적으로 자발적이며 학생 장학·교육·선교 사역에 사용됩니다. 사용 내역은 언제든 문의하실 수 있습니다.","faq.items.4.q":"AMAS를 어떻게 도울 수 있나요?","faq.items.4.a":"기도로 함께해 주세요. 학생 장학·교육·선교사 훈련을 위해 후원하실 수 있으며(「후원과 동역」 참조), 주변에 학교를 소개하는 것도 귀한 동역입니다.",
 ...
 th: {
  ...
  "hero.ai.title":"ศาสนศาสตร์เฉพาะบุคคล · ค้นพบขั้นการเติบโตใน 3 นาที","hero.ai.sub":"8 ข้อ · ภาพรวม 4 มิติ · คำแนะนำเฉพาะคุณ","hero.ai.go":"เริ่มเลย →",
  ...
  "giving.title":"ถวายสนับสนุน","giving.verse":"“ทุกคนจงให้ตามที่ตนคิดหมายไว้ในใจ มิใช่ด้วยนิสัยเสียดายหรือด้วยความจำใจ เพราะว่าพระเจ้าทรงรักคนที่ให้ด้วยใจยินดี”","giving.verseRef":"— 2 โครินธ์ 9:7","giving.desc":"การศึกษาศาสนศาสตร์เป็นพันธกิจที่ร่วมกันทำ การถวายของคุณช่วยให้ผู้เรียนเรียนจนจบ และหนุนการสอนกับพันธกิจมิชชัน","giving.d1":"ทุนการศึกษา","giving.d1b":"ช่วยผู้เรียนที่ขาดแคลนทุนทรัพย์","giving.d2":"พันธกิจการสอน","giving.d2b":"สนับสนุนคณาจารย์และหลักสูตร","giving.d3":"อบรมมิชชันนารี","giving.d3b":"สนับสนุนผู้เตรียมถูกส่งออก","giving.how":"ช่องทางถวาย","giving.tab.wechat":"WeChat","giving.tab.alipay":"Alipay","giving.tab.thai":"โอนไทย","giving.tab.intl":"ต่างประเทศ","giving.qrSoon":"QR จะเปิดให้เร็ว ๆ นี้ ติดต่อทีมงานก่อนได้","giving.thaiSoon":"ข้อมูลบัญชีธนาคารไทยจะประกาศเร็ว ๆ นี้","giving.intlSoon":"ข้อมูล PayPal และโอนระหว่างประเทศจะประกาศเร็ว ๆ นี้ อีเมล amasthai2026@gmail.com","giving.notify":"ถวายแล้วบอกเราด้วย","giving.notifyDesc":"ฝากข้อมูลไว้เพื่อให้ทีมงานยืนยันและขอบคุณพระคุณสำหรับคุณ","giving.fName":"ชื่อ","giving.fAmount":"จำนวน (ไม่บังคับ)","giving.fDir":"วัตถุประสงค์","giving.dGeneral":"ให้วิทยาลัยจัดสรร","giving.fContact":"ช่องทางติดต่อ (ไม่บังคับ)","giving.send":"ส่งแจ้ง","giving.ok":"ได้รับแล้ว ขอพระเจ้าทรงระลึกถึงของถวายของคุณ!","giving.fail":"ส่งไม่สำเร็จ โปรดลองใหม่หรือติดต่อเรา","giving.note":"การถวายเป็นไปโดยสมัครใจ ใช้เพื่อทุนการศึกษา การสอน และมิชชัน สอบถามการใช้ได้ทุกเมื่อ","faq.items.4.q":"จะสนับสนุน AMAS ได้อย่างไร?","faq.items.4.a":"อธิษฐานเผื่อเรา ถวายเพื่อทุนการศึกษา การสอน หรืออบรมมิชชันนารี (ดูส่วนถวายสนับสนุน) หรือแนะนำวิทยาลัยให้คนที่เหมาะสม",
