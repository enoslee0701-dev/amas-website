...
const i18n = {
 zh: {
  ...
  "chat.kb.courses":"按学院官方课程体系开设 67 门课程（新约 27 卷、旧约书卷、圣经基础与研经、神学与思想、实践神学与牧养、历史与文化、语言与工具 7 大类）与属灵训练项目，硕士班 G.Dip / M.Div 毕业 90 学分，涵盖圣经、系统、历史、实践神学与圣经语言。","chat.kb.coursesBtn":"浏览课程",
 ...
 en: {
  ...
  "chat.kb.courses":"The official curriculum offers 67 courses in 7 categories (all 27 NT books, OT books, Bible study skills, theology, practical ministry, history & culture, languages & tools) plus spiritual-training items; the G.Dip / M.Div track graduates with 90 credits, spanning Bible, theology, history, ministry and biblical languages.","chat.kb.coursesBtn":"Browse courses",
 ...
 ko: {
  ...
  "chat.kb.courses":"공식 커리큘럼으로 7개 분야 67개 과목(신약 27권 전권, 구약, 성경 기초·연구, 신학, 실천·목회, 역사·문화, 언어·도구)과 영성 훈련 항목을 개설하며, 석사 과정(G.Dip / M.Div) 졸업 학점은 90학점입니다. 성경·신학·역사·실천·성경 언어를 아우릅니다.","chat.kb.coursesBtn":"과목 살펴보기",
 ...
 th: {
  ...
  "chat.kb.courses":"หลักสูตรทางการมี 67 วิชาใน 7 หมวด (พันธสัญญาใหม่ครบ 27 เล่ม พันธสัญญาเดิม พื้นฐานพระคัมภีร์ ศาสนศาสตร์ พันธกิจ ประวัติศาสตร์และวัฒนธรรม ภาษาและเครื่องมือ) และรายการฝึกฝ่ายวิญญาณ หลักสูตร G.Dip / M.Div จบที่ 90 หน่วยกิต ครอบคลุมพระคัมภีร์ ศาสนศาสตร์ ประวัติศาสตร์ พันธกิจ และภาษาพระคัมภีร์","chat.kb.coursesBtn":"ดูรายวิชา",
